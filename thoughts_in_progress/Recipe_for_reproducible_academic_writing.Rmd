...
Now we are having pretty much of the functionality we would want to. However, human desire is boundless, and we certainly want more. Pressingly, it would be nice if the document would automatically be formatted to suit the requirements of the APA, from a psychologist's point of view. Similar things may be said for other fields. Here, we explore next how to automatically format your document to APA (6ed.) style. See [here](https://bitbucket.org/zuline/md2latex) for more details.
